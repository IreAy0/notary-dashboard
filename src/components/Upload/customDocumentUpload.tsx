...
const CustomTemplateUpload = ({ label, placeholder, fileRule, iconName, maxFilesize, isClose, updateDom, showPreview = false }: Props) => {
...
<path d="M5.44249 0.228516H5.08288L2.80516 2.74602L1.00684 4.7839H5.44244L5.44249 0.228516Z" fill="black"/>
   ...
   <div className="flex flex__center pt-2">
        ...
        <Button onClick={() => uploadDocument()} type='button' disabled={!fileData.title || loading} loading={loading} size='sm' theme='primary'  height={50} width={200}>
          Confirm
        </Button>
      </div>
  </div>
...
CustomTemplateUpload.defaultProps = {
  iconName: '',
  showPreview: false
}
